...
public class S4ClassResource {
    ...
    public Response getClasses(
        ...
        return s4ClassService.retrieveAll(pageIndex, pageSize, search);
    }
    ...
    @Path("/title/{title}")
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public Response getClassByTitle(@PathParam("title") String title) {
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public Response getClassByDescription(@PathParam("description") String description) {
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public Response getClassByClassCode(@PathParam("studentId") String studentId) {
    ...
    @Path("/{code}")
    @Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    public Response updateClass(@PathParam("code") String code, ClassDto classDto) {
